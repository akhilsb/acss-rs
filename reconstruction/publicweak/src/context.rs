    ...
    pub fn spawn(
        ...
        tokio::spawn(async move {
            let mut c = Context {
                ...
                modulus: 17, // TODO: where do I get the modulus from?
                shares: Vec::new(),
                sharings: Vec::new(),

                received_sharing_of_shares: HashMap::new(),
                ...
                sync_msg = self.sync_recv.recv() =>{
                    ...
                    match sync_msg.state {
                        SyncState::START =>{
                            ...
                            self.start_reconstruction().await;
                        ...
                        SyncState::STOP =>{
                            ...
                            log::error!("Reconstruction Stop time: {:?}", SystemTime::now()
                                .duration_since(UNIX_EPOCH)
                                .unwrap()
                                .as_millis());
                            log::info!("Termination signal received by the server. Exiting.");
...
pub struct Context {
    ...
    //                                      group_id       evaluation_point   share
    pub received_sharing_of_shares: HashMap<i64,   HashMap<i64,                i64>>,

    //                          group_id      evaluation_point   share
    pub received_shares: HashMap<i64, HashMap<i64,               i64>>,

    //                   group_id          reconstructed secrets for the group
    pub results: HashMap<i64,       Option<Vec<i64>>>,
}
